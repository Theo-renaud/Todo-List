                ...
                <div class="col-md-12">
                    <div class="card px-3">
                        <div class="card-body">
                            ...
                            <div class="add-items d-flex"> <input type="text" class="form-control todo-list-input" placeholder="Ajoutez une nouvelle tâche ici"> <button class="add btn btn-primary font-weight-bold todo-list-add-btn">Add</button> </div>
